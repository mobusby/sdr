...
# Generated: Sat Apr  1 21:19:36 2017
##################################################
...
class uhd_fft(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, antenna='RX2', args='', fft_size=1024, freq=2.45e9, gain=20, samp_rate=1e6, spec='', stream_args='', update_rate=.1, wire_format=''):
        ...
        self._samp_rate__line_edit.returnPressed.connect(
        	lambda: self.set_samp_rate_(eval(str(self._samp_rate__line_edit.text().toAscii()))))
    ...
    def set_samp_rate_(self, samp_rate_):
        ...
        Qt.QMetaObject.invokeMethod(self._samp_rate__line_edit, "setText", Qt.Q_ARG("QString", repr(self.samp_rate_)))
